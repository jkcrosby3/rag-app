#!/usr/bin/env python
"""Test script for the semantic cache with mock LLM responses.

This script tests the performance of the semantic cache for LLM responses
implemented in the RAG system, using mock responses to avoid API calls.
"""
import sys
import os
import time
...
# Import the semantic cache directly
...
def main():
    ...
    semantic_results_file = results_dir / "semantic_cache_mock_results.json"
