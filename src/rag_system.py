...
class RAGSystem:
    ...
    def __init__(
        ...
        llm_model_name: str = "claude-sonnet-4-6",  # Latest Claude 4 Sonnet
    ...
    def process_query(
        ...
        # Apply clearance-based filtering and redaction (only if user has clearance)
        # For public/demo data, skip redaction
        if self.user_id and user_clearance:
