...
DEFAULT_MAX_TOKENS = 4000  # Increased for detailed responses with enumerations
...
For counting or enumeration questions:
- Systematically review ALL provided documents
- Create a complete list of unique items (names, dates, etc.)
- Provide the total count
- List each unique item found across all documents
- Note if the same item appears in multiple documents"""
...
class ClaudeClient(BaseLLMClient):
    ...
    def __init__(
        ...
        if self.api_key:
            # Create httpx client without SSL verification for corporate networks
            import httpx
