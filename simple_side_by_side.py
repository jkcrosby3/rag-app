"""
Simple RAG System Web Interface with side-by-side source documents
"""
import os
import sys
import json
...
def index():
    ...
    # Add test chat item if available and session is empty
    if not session['chat_history'] and 'TEST_CHAT_ITEM' in app.config:
